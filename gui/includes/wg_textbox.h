...
public:
	...
	CTextBox(const CRect& WindowRect, CWindow* pParent, CFontEngine* pFontEngine = 0);
...
private:
	void operator=(CTextBox) { }  //!< The assignment operator is not allowed for CWindow derived objects
