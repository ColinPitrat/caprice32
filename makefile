...
CLANG_CHECKS=modernize-*,performance-*,misc-*,-misc-definitions-in-headers,readability-*,-readability-implicit-bool-cast,-readability-braces-around-statements,-readability-function-size,-readability-magic-numbers,-misc-non-private-member-variables-in-classes,-misc-no-recursion,-modernize-avoid-c-arrays,-modernize-deprecated-headers,-modernize-make-unique,-modernize-use-auto,-modernize-use-default-member-init,-modernize-use-equals-delete,-modernize-use-trailing-return-type,-modernize-use-using,-performance-faster-string-find,-performance-unnecessary-value-param,-readability-avoid-const-params-in-decls,-readability-implicit-bool-conversion,-readability-isolate-declaration,-readability-make-member-function-const,-readability-qualified-auto,-readability-uppercase-literal-suffix,-modernize-use-nodiscard,-readability-convert-member-functions-to-static,-readability-use-anyofallof
